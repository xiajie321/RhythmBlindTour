...
{
    public class RhySlideLeftNoteManager : MonoBehaviour
    {
        public static RhySlideLeftNoteManager Instance { get;private set; }
        ...
        public List<RhySlideLeftNote> Notes = new();
        public float Lanes;
        ...
        {
            return RhyGameplayManager.Instance.IsPlaying && InputManager.Instance.CheckSlideLeft();
        }
