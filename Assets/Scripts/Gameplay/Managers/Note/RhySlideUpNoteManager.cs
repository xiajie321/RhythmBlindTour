...
{
    public class RhySlideUpNoteManager : MonoBehaviour
    {
        public static RhySlideUpNoteManager Instance { get; private set; }
        ...
        public List<RhySlideUpNote> Notes = new();
        public float Lanes;
        ...
        {
            return RhyGameplayManager.Instance.IsPlaying && InputManager.Instance.CheckSlideUp();
        }
